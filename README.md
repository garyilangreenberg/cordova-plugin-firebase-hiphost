[![Build Status](https://travis-ci.org/arnesson/cordova-plugin-firebase-hiphost.svg?branch=master)](https://travis-ci.org/arnesson/cordova-plugin-firebase-hiphost)
